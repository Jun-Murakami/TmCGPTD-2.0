    ...
    public partial class EditorThreeView : UserControl
    {
        public EditorThreeView()
        {
            ...
            this.AttachedToVisualTree += (sender, e) =>
            {
                ...
                VMLocator.EditorViewModel.Editor3Text = VMLocator.EditorViewModel.Editor3Text + br + VMLocator.EditorViewModel.Editor4Text + br + VMLocator.EditorViewModel.Editor5Text;
